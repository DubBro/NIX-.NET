    ...
    public class ProjectConfiguration : IEntityTypeConfiguration<Project>
    {
        public void Configure(EntityTypeBuilder<Project> builder)
        {
            ...
            builder.HasData(new List<Project>()
            {
                ...
                new Project() { ProjectId = 5, Name = "Ford Focus", Budget = 700, StartedDate = DateTime.ParseExact("01.02.2023", "d", null), ClientId = 4 },
                new Project() { ProjectId = 6, Name = "Ford Fiesta", Budget = 600, StartedDate = DateTime.ParseExact("01.02.2023", "d", null), ClientId = 4 },
                new Project() { ProjectId = 7, Name = "Ford Mondeo", Budget = 750, StartedDate = DateTime.ParseExact("01.03.2023", "d", null), ClientId = 4 },
                new Project() { ProjectId = 8, Name = "Ford Mustang", Budget = 1500, StartedDate = DateTime.ParseExact("01.04.2023", "d", null), ClientId = 4 },
                new Project() { ProjectId = 9, Name = "Electro magnetic motor", Budget = 2000, StartedDate = DateTime.ParseExact("01.05.2023", "d", null), ClientId = 5 },
                new Project() { ProjectId = 10, Name = "Dynamo electric machine", Budget = 2500, StartedDate = DateTime.ParseExact("22.03.2023", "d", null), ClientId = 5 },

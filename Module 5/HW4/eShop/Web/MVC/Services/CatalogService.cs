...
public class CatalogService : ICatalogService
{
    ...
    {
        var result = await _httpClient.SendAsync<IEnumerable<CatalogBrand>, object>($"{_settings.Value.CatalogUrl}/getbrands", HttpMethod.Get, null);
    ...
    {
        var result = await _httpClient.SendAsync<IEnumerable<CatalogType>, object>($"{_settings.Value.CatalogUrl}/gettypes", HttpMethod.Get, null);

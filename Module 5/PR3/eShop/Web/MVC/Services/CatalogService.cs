...
public class CatalogService : ICatalogService
{
    ...
    public async Task<Catalog> GetCatalogItems(int page, int take, int? brand, int? type)
    {
        ...
        await _httpClient.SendAsync<object, object>($"{_settings.Value.BasketUrl}/logmessage", HttpMethod.Post, null);
        await _httpClient.SendAsync<object, object>($"{_settings.Value.BasketUrl}/loguserid", HttpMethod.Post, null);
